        ...
        return(
            <div className="home-instruments-wrap container-fluid">
                ...
                <div className="home-instruments-body">
                    <label htmlFor="home-instruments-sub" className="home-instruments-label"><i className="fas fa-angle-double-down"></i></label>
                        <input type="checkbox" id="home-instruments-sub"></input>
                    <div className="row home-instruments-row home-d-flex ">
                        {
